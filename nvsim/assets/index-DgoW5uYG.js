import{f as it,u as rt,i as f,a as y,b as l,w as J}from"./lit-BS7WqYd5.js";import{y as p,g as ot,j as w}from"./signals-SG45zFCj.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function a(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=a(s);fetch(s.href,r)}})();/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const x=e=>(t,a)=>{a!==void 0?a.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const nt={attribute:!0,type:String,converter:rt,reflect:!1,hasChanged:it},lt=(e=nt,t,a)=>{const{kind:i,metadata:s}=a;let r=globalThis.litPropertyMetadata.get(s);if(r===void 0&&globalThis.litPropertyMetadata.set(s,r=new Map),i==="setter"&&((e=Object.create(e)).wrapped=!0),r.set(a.name,e),i==="accessor"){const{name:o}=a;return{set(n){const d=t.get.call(this);t.set.call(this,n),this.requestUpdate(o,d,e,!0,n)},init(n){return n!==void 0&&this.C(o,void 0,e,n),n}}}if(i==="setter"){const{name:o}=a;return function(n){const d=this[o];t.call(this,n),this.requestUpdate(o,d,e,!0,n)}}throw Error("Unsupported decorator location: "+i)};function Ce(e){return(t,a)=>typeof a=="object"?lt(e,t,a):((i,s,r)=>{const o=s.hasOwnProperty(r);return s.constructor.createProperty(r,i),o?Object.getOwnPropertyDescriptor(s,r):void 0})(e,t,a)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ye(e,t){return(a,i,s)=>{const r=o=>o.renderRoot?.querySelector(e)??null;return dt(a,i,{get(){return r(this)}})}}var ct=Object.defineProperty,pt=Object.getOwnPropertyDescriptor,Xe=(e,t,a,i)=>{for(var s=i>1?void 0:i?pt(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&ct(t,a,s),s};let ke=class extends y{constructor(){super(...arguments),this.view="scene"}navigate(e){this.dispatchEvent(new CustomEvent("navigate",{detail:e}))}render(){return l`
  ...
  `;Xe([Ce()],ke.prototype,"view",2);ke=Xe([x("nv-rail")],ke);const A=p("wasm"),Fe=p("");p(!1);p(null);const h=p(!1);p(!0);const ye=p(1),ut=p(0),Ie=p(0n),W=p(0xCAFEBABEn),K=p(1e4),Y=p(1e3),X=p(1),Q=p(!0),k=p("dark"),_=p("default"),T=p(!1),re=p(!0),he=p([0,0,0]),V=p(0),L=p(0),M=p(0),z=p(""),$=p("idle"),R=p(""),B=p(null),pe=p([]),$e=p([]),Se=p([]),ue=p([]),qe=p("rebar-walkby-01"),vt=p(""),le=p(!1),Oe=p("all"),q=p([]);function ht(e){const t=q.value.slice();for(t.push(e);t.length>200;)t.shift();q.value=t}const ve=p([]),Ve=ot(()=>A.value==="wasm"?"wasm":"ws");let Qe=null;function mt(e){Qe=e}function b(){return Qe}const P=p([]),gt=200;function c(e,t){if(le.value)return;const a=P.value.slice();for(a.push({ts:Date.now(),level:e,msg:t});a.length>gt;)a.shift();P.value=a}function bt(e){const a=pe.value.slice();a.push(e[0]),a.length>200&&a.shift();const i=$e.value.slice();i.push(e[1]),i.length>200&&i.shift();const s=Se.value.slice();s.push(e[2]),s.length>200&&s.shift(),pe.value=a,$e.value=i,Se.value=s}function ft(e){const a=ue.value.slice();for(a.push(Math.max(0,Math.min(1,e)));a.length>48;)a.shift();ue.value=a}var yt=Object.defineProperty,xt=Object.getOwnPropertyDescriptor,be=(e,t,a,i)=>{for(var s=i>1?void 0:i?xt(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&yt(t,a,s),s};let j=class extends y{constructor(){super(...arguments),this.open=!1,this.mTitle="",this.mBody="",this.buttons=[],this.onModal=e=>{const t=e.detail;this.mTitle=t.title,this.mBody=t.body,this.buttons=t.buttons??[{label:"Close",variant:"primary"}],this.open=!0,this.setAttribute("open",""),requestAnimationFrame(()=>{const a=this.shadowRoot;if(!a)return;a.querySelector("input, select, textarea, button:not(.close)")?.focus()})},this.onKey=e=>{e.key==="Escape"&&this.open&&this.close()}}connectedCallback(){super.connectedCallback(),window.addEventListener("nv-modal",this.onModal),window.addEventListener("keydown",this.onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("nv-modal",this.onModal),window.removeEventListener("keydown",this.onKey)}updated(){if(!this.open)return;const e=this.shadowRoot;if(!e)return;const t=a=>{if(a.key!=="Tab")return;const i=Array.from(e.querySelectorAll("input, select, textarea, button, [href]")).filter(n=>!n.hasAttribute("disabled"));if(i.length===0)return;const s=i[0],r=i[i.length-1],o=e.activeElement??null;a.shiftKey&&o===s?(a.preventDefault(),r.focus()):!a.shiftKey&&o===r&&(a.preventDefault(),s.focus())};e.removeEventListener("keydown",t),e.addEventListener("keydown",t)}close(){this.open=!1,this.removeAttribute("open")}clickBtn(e){e.onClick?.(),this.close()}render(){return l`
  ...
  `;be([u()],j.prototype,"open",2);be([u()],j.prototype,"mTitle",2);be([u()],j.prototype,"mBody",2);be([u()],j.prototype,"buttons",2);j=be([x("nv-modal")],j);function de(e){window.dispatchEvent(new CustomEvent("nv-modal",{detail:e}))}var wt=Object.defineProperty,kt=Object.getOwnPropertyDescriptor,Ae=(e,t,a,i)=>{for(var s=i>1?void 0:i?kt(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&wt(t,a,s),s};let Z=class extends y{constructor(){super(...arguments),this.visible=!1,this.msg="",this.icon="✓",this.timer=null,this.onToast=e=>{const t=e.detail;this.msg=t.msg??"Done",this.icon=t.icon??"✓",this.visible=!0,this.setAttribute("visible",""),this.timer!==null&&window.clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this.visible=!1,this.removeAttribute("visible")},1800)}}connectedCallback(){super.connectedCallback(),window.addEventListener("nv-toast",this.onToast)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("nv-toast",this.onToast)}render(){return l`<span class="icon">${this.icon}</span><span>${this.msg}</span>`}};Z.styles=f`
    :host {
  ...
  `;Ae([u()],Z.prototype,"visible",2);Ae([u()],Z.prototype,"msg",2);Ae([u()],Z.prototype,"icon",2);Z=Ae([x("nv-toast")],Z);function C(e,t="✓"){window.dispatchEvent(new CustomEvent("nv-toast",{detail:{msg:e,icon:t}}))}var $t=Object.getOwnPropertyDescriptor,St=(e,t,a,i)=>{for(var s=i>1?void 0:i?$t(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=o(s)||s);return s};let Ne=class extends y{connectedCallback(){super.connectedCallback(),w(()=>{M.value,Ve.value,W.value,k.value,qe.value,h.value,this.requestUpdate()})}async toggleRun(){const e=b();e&&(h.value?(await e.pause(),h.value=!1):(await e.run(),h.value=!0))}async reset(){const e=b();e&&await e.reset()}toggleTheme(){k.value=k.value==="dark"?"light":"dark"}async openSeedModal(){const e=`0x${W.value.toString(16).toUpperCase().padStart(8,"0")}`;de({title:"Set seed",body:`<p>Set the 32-bit hex seed for the shot-noise PRNG. Same <code>(scene, config, seed)</code> → byte-identical witness.</p>
        <label>Hex seed</label>
        <input type="text" id="seed-input" value="${e}" autofocus />`,buttons:[{label:"Cancel",variant:"ghost"},{label:"Apply",variant:"primary",onClick:async()=>{const t=document.querySelector("nv-modal")?.shadowRoot?.querySelector("#seed-input");if(!t)return;const a=t.value.trim().replace(/^0x/i,""),i=BigInt("0x"+a);W.value=i,await b()?.setSeed(i),c("ok",`seed → 0x${i.toString(16).toUpperCase()}`),C(`Seed → 0x${i.toString(16).toUpperCase().slice(0,8)}`,"⟳")}}]})}openTransportSettings(){window.dispatchEvent(new CustomEvent("open-settings"))}render(){const e=W.value.toString(16).toUpperCase().padStart(8,"0");return l`
      <div class="crumbs">
        <span class="home">RuView</span><span class="sep">/</span>
        <span>nvsim</span><span class="sep">/</span>
        <span class="cur" id="scene-name">${qe.value}</span>
      </div>
      <div class="spacer"></div>
    ...
    button.ghost { background: transparent; }
  `;Ne=St([x("nv-topbar")],Ne);var _t=Object.getOwnPropertyDescriptor,zt=(e,t,a,i)=>{for(var s=i>1?void 0:i?_t(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=o(s)||s);return s};let He=null;function xe(){He!==null&&window.clearTimeout(He),He=window.setTimeout(async()=>{const e=b();if(e)try{await e.setConfig({digitiser:{f_s_hz:K.value,f_mod_hz:Y.value},sensor:{gamma_fwhm_hz:1e6,t1_s:.005,t2_s:1e-6,t2_star_s:2e-7,contrast:.03,n_spins:1e12,shot_noise_disabled:!Q.value},dt_s:X.value*.001}),c("dbg",`config pushed · fs=${K.value} f_mod=${Y.value} dt=${X.value.toFixed(1)}ms noise=${Q.value?"on":"off"}`)}catch(t){c("warn",`config push failed: ${t.message}`)}},300)}let We=class extends y{connectedCallback(){super.connectedCallback(),w(()=>{K.value,Y.value,X.value,Q.value,h.value,this.requestUpdate()})}render(){return l`
      <div class="panel">
      ...
      <div class="panel">
        ...
        <div class="slider-row" title="Digitiser sample rate — frames per second emitted by the pipeline">
          <div class="top"><span class="lbl">Sample rate</span><span class="val">${(K.value/1e3).toFixed(1)} kHz</span></div>
          <input type="range" min="1000" max="100000" .value=${String(K.value)}
            aria-label="Sample rate in Hz"
            @input=${e=>{K.value=+e.target.value,xe()}} />
        </div>
        <div class="slider-row" title="Microwave modulation frequency for lock-in demodulation">
          <div class="top"><span class="lbl">Lockin f_mod</span><span class="val">${(Y.value/1e3).toFixed(3)} kHz</span></div>
          <input type="range" min="100" max="5000" .value=${String(Y.value)}
            aria-label="Lock-in modulation frequency in Hz"
            @input=${e=>{Y.value=+e.target.value,xe()}} />
        </div>
        <div class="slider-row" title="Per-sample integration time">
          <div class="top"><span class="lbl">Integration t</span><span class="val">${X.value.toFixed(1)} ms</span></div>
          <input type="range" min="0.1" max="10" step="0.1" .value=${String(X.value)}
            aria-label="Integration time in milliseconds"
            @input=${e=>{X.value=+e.target.value,xe()}} />
        </div>
        <div class="slider-row" title="Toggle shot-noise sampling. OFF = analytic noise-free output (debug only)">
          ...
          <input type="range" min="0" max="1" .value=${Q.value?"1":"0"}
            ...
            @input=${e=>{Q.value=e.target.value==="1",xe()}} />
        </div>
      </div>
      ...
      <div class="panel">
        ...
        <div class="pipeline">
          <span class="stage ${h.value?"live":""}">scene</span>
          <span class="stage-arrow">→</span>
          <span class="stage ${h.value?"live":""}">B-S</span>
          <span class="stage-arrow">→</span>
          <span class="stage ${h.value?"live":""}">prop</span>
          <span class="stage-arrow">→</span>
          <span class="stage ${h.value?"live":""}">NV</span>
          <span class="stage-arrow">→</span>
          <span class="stage ${h.value?"live":""}">ADC</span>
          <span class="stage-arrow">→</span>
          <span class="stage ${h.value?"live":""}">frame</span>
        </div>
      </div>
    `}};We.styles=f`
    :host {
  ...
  `;We=zt([x("nv-sidebar")],We);var Tt=Object.defineProperty,Mt=Object.getOwnPropertyDescriptor,se=(e,t,a,i)=>{for(var s=i>1?void 0:i?Mt(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Tt(t,a,s),s};let E=class extends y{constructor(){super(...arguments),this.zoom=1,this.layerVisible={source:!0,field:!0,label:!0},this.items=[{id:"rebar",x:740,y:240,color:"oklch(0.72 0.18 330)",name:"rebar.steel"},{id:"heart",x:220,y:180,color:"oklch(0.78 0.14 195)",name:"heart_proxy"},{id:"mains",x:180,y:380,color:"oklch(0.72 0.18 330)",name:"mains_60Hz"},{id:"door",x:800,y:470,color:"oklch(0.78 0.14 145)",name:"door.steel"}],this.dragging=null,this.selected=null,this.dragOffset={dx:0,dy:0},this.onDown=(e,t)=>{t.preventDefault(),this.dragging=e,this.selected=e;const a=this.items.find(r=>r.id===e);if(!a)return;const i=this.renderRoot.querySelector("svg");if(!i)return;const s=this.toSvg(t,i);this.dragOffset={dx:s.x-a.x,dy:s.y-a.y}},this.onPointerMove=e=>{if(!this.dragging)return;const t=this.renderRoot.querySelector("svg");if(!t)return;const a=this.toSvg(e,t);this.items=this.items.map(i=>i.id===this.dragging?{...i,x:a.x-this.dragOffset.dx,y:a.y-this.dragOffset.dy}:i)},this.onPointerUp=()=>{this.dragging&&(ve.value=this.items.map(({id:e,x:t,y:a})=>({id:e,x:t,y:a}))),this.dragging=null}}connectedCallback(){super.connectedCallback(),ve.value.length>0&&(this.items=this.items.map(e=>{const t=ve.value.find(a=>a.id===e.id);return t?{...e,x:t.x,y:t.y}:e})),w(()=>{he.value,V.value,M.value,L.value,T.value,h.value,ye.value,B.value,this.requestUpdate()}),w(()=>{const e=B.value;if(!e)return;const t=Math.sqrt(e.bPt[0]**2+e.bPt[1]**2+e.bPt[2]**2),a=Math.max(Math.abs(e.sigmaPt[0]),Math.abs(e.sigmaPt[1]),Math.abs(e.sigmaPt[2]),.001),i=t/a;Number.isFinite(i)&&(L.value=i)}),window.addEventListener("pointermove",this.onPointerMove),window.addEventListener("pointerup",this.onPointerUp)}async toggleRun(){const e=b();e&&(h.value?(await e.pause(),h.value=!1):(await e.run(),h.value=!0))}async stepFwd(){const e=b();e&&(await e.step("fwd",10),c("dbg","sim step → +1 frame"))}async stepBack(){const e=b();e&&(await e.step("back",10),c("dbg","sim step ← -1 frame"))}cycleSpeed(){const e=[.25,.5,1,2,4],t=e.indexOf(ye.value);ye.value=e[(t+1)%e.length]}zoomIn(){this.zoom=Math.min(2.5,this.zoom*1.2)}zoomOut(){this.zoom=Math.max(.5,this.zoom/1.2)}fitView(){this.zoom=1}toggleLayer(e){this.layerVisible={...this.layerVisible,[e]:!this.layerVisible[e]}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("pointermove",this.onPointerMove),window.removeEventListener("pointerup",this.onPointerUp)}toSvg(e,t){const a=t.getBoundingClientRect(),i=(e.clientX-a.left)/a.width*1e3,s=(e.clientY-a.top)/a.height*600;return{x:i,y:s}}render(){const e=he.value,t=[e[0]*1e9,e[1]*1e9,e[2]*1e9],a=V.value*1e9,i=T.value?"":"anim",s=1e3/this.zoom,r=600/this.zoom,o=(1e3-s)/2,n=(600-r)/2;return l`
      <div class="grid"></div>
      <svg viewBox="${o.toFixed(1)} ${n.toFixed(1)} ${s.toFixed(1)} ${r.toFixed(1)}"
        ...
        ${this.layerVisible.field?this.items.map(d=>J`
          <line class="field-line ${i}" x1=${d.x} y1=${d.y}
            x2="500" y2="320"
            stroke=${d.color} stroke-width="1" stroke-opacity="0.5"/>
        `):""}

        <!-- Source primitives -->
        ${this.layerVisible.source?this.items.map(d=>J`
          <g class=${`draggable ${this.dragging===d.id?"dragging":""} ${this.selected===d.id?"selected":""}`}
             ...
             @pointerdown=${v=>this.onDown(d.id,v)}>
            ...
            ${this.layerVisible.label?J`<text class="label" x="0" y="40" text-anchor="middle">${d.name}</text>`:""}
          </g>
        `):""}
      ...
      <div class="sim-controls" id="sim-controls">
        ...
        <span class="speed" id="speed-val" title="Cycle speed" @click=${this.cycleSpeed}>${ye.value}×</span>
      </div>
      ...
      <div class="scene-readout">
        ...
        <div class="stat-card">
          ...
          <div class="val mint" id="snr-readout">${L.value>0?L.value.toFixed(1):"—"}</div>
        </div>
      </div>
    `}};E.styles=f`
    :host {
  ...
  `;se([u()],E.prototype,"zoom",2);se([u()],E.prototype,"layerVisible",2);se([u()],E.prototype,"items",2);se([u()],E.prototype,"dragging",2);se([u()],E.prototype,"selected",2);E=se([x("nv-scene")],E);var Ct=Object.defineProperty,At=Object.getOwnPropertyDescriptor,Pe=(e,t,a,i)=>{for(var s=i>1?void 0:i?At(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Ct(t,a,s),s};let ee=class extends y{constructor(){super(...arguments),this.tab="signal",this.pinTab=null,this.expanded=!1}connectedCallback(){super.connectedCallback(),w(()=>{pe.value,$e.value,Se.value,ue.value,B.value,z.value,$.value,he.value,V.value,this.requestUpdate()})}willUpdate(e){e.has("pinTab")&&this.pinTab&&this.tab!==this.pinTab&&(this.tab=this.pinTab)}async verify(){const e=b();if(e){$.value="pending",c("info","verifying witness over 256 frames…");try{const t=R.value,a=new Uint8Array(32);for(let s=0;s<32;s++)a[s]=parseInt(t.slice(s*2,s*2+2),16);const i=await e.verifyWitness(a);if(i.ok)$.value="ok",z.value=t,c("ok",`witness ${t.slice(0,16)}… matches · determinism gate ✓`);else{$.value="fail";const s=Array.from(i.actual).map(r=>r.toString(16).padStart(2,"0")).join("");z.value=s,c("err",`WITNESS MISMATCH actual=${s.slice(0,16)}…`)}}catch(t){$.value="fail",c("err",`verify failed: ${t.message}`)}}}renderHeader(){return this.expanded?l`
    ...
    `:""}renderSignalTab(){const r=v=>{let m="";return v.forEach((g,G)=>{const Ee=G/Math.max(1,199)*320,De=65-g*22;m+=(G===0?"M":"L")+` ${Ee.toFixed(1)} ${De.toFixed(1)} `}),m},o=he.value,n=[o[0]*1e9,o[1]*1e9,o[2]*1e9],d=pe.value.length>0;return l`
      ${d?"":l`
      ...
      <div class=${this.expanded?"grid-2":""}>
        <div class="card">
          ...
          <svg viewBox="0 0 ${320} ${130}" preserveAspectRatio="none">
            ...
            ${J`<path id="trace-x" d=${r(pe.value)} stroke="oklch(0.78 0.14 70)" stroke-width="1.2" fill="none"/>`}
            ${J`<path id="trace-y" d=${r($e.value)} stroke="oklch(0.78 0.12 195)" stroke-width="1.2" fill="none" opacity="0.8"/>`}
            ${J`<path id="trace-z" d=${r(Se.value)} stroke="oklch(0.72 0.18 330)" stroke-width="1.2" fill="none" opacity="0.7"/>`}
          </svg>
          ${this.expanded?l`<div style="display:flex;gap:14px;font-size:12px;font-family:var(--mono);margin-top:8px;">
            <span style="color:oklch(0.78 0.14 70);">x: ${n[0].toFixed(3)} nT</span>
            <span style="color:oklch(0.78 0.12 195);">y: ${n[1].toFixed(3)} nT</span>
            <span style="color:oklch(0.72 0.18 330);">z: ${n[2].toFixed(3)} nT</span>
        ...
        <div class="card">
          ...
          <div class="frame-strip" id="frame-strip">
            ${ue.value.map(v=>l`<div class="bar" style=${`height:${Math.max(4,v*100)}%`}></div>`)}
          </div>
          ${this.expanded?l`
            <div style="display:flex;gap:24px;font-family:var(--mono);font-size:12px;color:var(--ink-3);margin-top:12px;">
              <span>frames in window: <span style="color:var(--ink);">${ue.value.length}</span></span>
              <span>noise floor: <span style="color:var(--ink);">${B.value?B.value.noiseFloorPtSqrtHz.toFixed(2)+" pT/√Hz":"—"}</span></span>
            </div>`:""}
        </div>
      </div>
    `}renderFrameTab(){const e=B.value,t=e?.raw;let a="";return t&&(a=Array.from(t).map(s=>s.toString(16).padStart(2,"0")).slice(0,60).join(" ")),l`
      ${e?"":l`
        <div class="card" style="text-align:center; padding:18px;">
          <div style="font-size:13px; color:var(--ink-2); line-height:1.55;">
    ...
    `}renderWitnessTab(){const e=$.value,t=e==="ok"?"ok":e==="fail"?"fail":"",a=e==="pending"?"Verifying…":e==="ok"?"✓ Witness verified · determinism gate":e==="fail"?"✗ Witness mismatch · audit required":"Verify witness",i=R.value&&z.value&&R.value===z.value;return l`
      ${this.expanded?l`
  ...
  `;Pe([u()],ee.prototype,"tab",2);Pe([Ce({attribute:!1})],ee.prototype,"pinTab",2);Pe([Ce({type:Boolean,reflect:!0})],ee.prototype,"expanded",2);ee=Pe([x("nv-inspector")],ee);var Pt=Object.defineProperty,Rt=Object.getOwnPropertyDescriptor,Je=(e,t,a,i)=>{for(var s=i>1?void 0:i?Rt(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Pt(t,a,s),s};let _e=class extends y{constructor(){super(...arguments),this.hIdx=-1,this.onKey=e=>{if(e.key==="Enter")this.exec(this.inputEl.value),this.inputEl.value="";else if(e.key==="ArrowUp"){const t=q.value;t.length&&(this.hIdx=Math.max(0,this.hIdx-1),this.inputEl.value=t[this.hIdx]??"",e.preventDefault())}else if(e.key==="ArrowDown"){const t=q.value;t.length&&(this.hIdx=Math.min(t.length,this.hIdx+1),this.inputEl.value=t[this.hIdx]??"",e.preventDefault())}}}connectedCallback(){super.connectedCallback(),w(()=>{P.value,Oe.value,le.value,this.requestUpdate()})}updated(){const e=this.renderRoot.querySelector(".body");e&&(e.scrollTop=e.scrollHeight)}counts(){const e={info:0,warn:0,err:0,dbg:0,ok:0};for(const t of P.value)e[t.level]=(e[t.level]??0)+1;return e.all=P.value.length,e}async exec(e){if(e=e.trim(),!e)return;c("info",`<span style="color:var(--accent);">nvsim&gt;</span> ${e}`),ht(e),this.hIdx=q.value.length;const[t,...a]=e.split(/\s+/),i=a.join(" "),s=b();switch(t){case"help":c("info","commands: help · scene.list · sensor.config · run · pause · reset · seed · proof.verify · proof.export · clear · theme · status");break;case"scene.list":c("info","scene rebar-walkby-01:"),c("info","  rebar.steel.coil   @ [+2.7, 0.0, +0.3] m χ=5000"),c("info","  dipole.heart_proxy @ [-1.4, +0.2, +0.4] m m=1.0e-6 A·m²"),c("info","  loop.mains_60Hz    @ [-1.6, -0.4, 0.0] m I=2 A"),c("info","  eddy.door_steel    @ [+0.0, +1.8, +0.4] m σ=1e6 S/m");break;case"sensor.config":c("info","NvSensor::cots_defaults() {"),c("info","  pos=[0,0,0], V=1mm³, N=1e12, C=0.03, T2*=200ns"),c("info","  D=2.870 GHz, γe=28 GHz/T, Γ=1.0 MHz, axes=4×〈111〉"),c("info","  δB ≈ 1.18 pT/√Hz (Barry 2020 §III.A) }");break;case"run":s&&(await s.run(),h.value=!0,c("ok","pipeline RUN"));break;case"pause":s&&(await s.pause(),h.value=!1,c("warn","pipeline PAUSED"));break;case"reset":s&&(await s.reset(),c("info","pipeline reset · t=0"));break;case"seed":{if(!i){c("info",`current seed = 0x${W.value.toString(16).toUpperCase()}`);break}const r=BigInt(i.startsWith("0x")?i:"0x"+i);W.value=r,s&&await s.setSeed(r),c("ok",`seed → 0x${r.toString(16).toUpperCase()}`);break}case"proof.verify":{if(!s)break;c("dbg","computing SHA-256 over 256 frames…");try{const r=R.value,o=new Uint8Array(32);for(let d=0;d<32;d++)o[d]=parseInt(r.slice(d*2,d*2+2),16);(await s.verifyWitness(o)).ok?($.value="ok",z.value=r,c("ok",`witness ${r.slice(0,16)}… matches · determinism gate ✓`)):($.value="fail",c("err","WITNESS MISMATCH"))}catch(r){c("err",`verify failed: ${r.message}`)}break}case"proof.export":{if(!s)break;c("dbg","building proof bundle…");try{const r=await s.exportProofBundle(),o=URL.createObjectURL(r),n=document.createElement("a");n.href=o,n.download=`nvsim-proof-${Date.now()}.json`,n.click(),URL.revokeObjectURL(o),c("ok",`proof bundle exported · ${r.size} bytes`)}catch(r){c("err",`export failed: ${r.message}`)}break}case"clear":P.value=[];break;case"theme":{const r=(i||"").toLowerCase();r==="light"||r==="dark"?(k.value=r,c("ok",`theme → ${r}`)):c("info","theme [light|dark]");break}case"status":c("info",`running=${h.value} seed=0x${W.value.toString(16).toUpperCase()} verified=${$.value}`);break;default:c("err",`unknown command: ${t} · try help`)}}render(){const e=this.counts(),t=Oe.value,a=P.value.filter(i=>t==="all"||i.level===t);return l`
      <div class="tabs">
        ${["all","info","warn","err","dbg"].map(i=>l`
        ...
        <div class="tools">
          ...
          <button id="pause-log" title="Pause" @click=${()=>le.value=!le.value}>
            ${le.value?"▶":"❚❚"}
          </button>
        </div>
      </div>
      <div class="body" role="log" aria-live="polite" aria-label="Console output">
        ${a.map(i=>{const s=new Date(i.ts),r=`${String(s.getSeconds()).padStart(2,"0")}.${String(s.getMilliseconds()).padStart(3,"0")}`;return l`<div class="line ${i.level}">
            <div class="ts">${r}</div>
  ...
  `;Je([Ye("#console-input")],_e.prototype,"inputEl",2);_e=Je([x("nv-console")],_e);const ce=[{id:"nvsim",name:"nvsim — NV-diamond magnetometer",category:"sim",crate:"nvsim",summary:"Deterministic forward simulator: scene → Biot–Savart → NV ensemble → ADC → MagFrame stream + SHA-256 witness.",budget:"L",active:!0,status:"available",tags:["quantum","magnetometer","simulator","witness","wasm"],adr:"ADR-089"},{id:"gesture",name:"Gesture (DTW)",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"Dynamic-Time-Warping gesture classifier from CSI motion templates.",events:[1],budget:"M",status:"available",tags:["hci","csi","classifier","dtw"],adr:"ADR-014"},{id:"coherence",name:"Coherence gate",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"Z-score coherence scoring + Accept/PredictOnly/Reject/Recalibrate gate.",events:[2],budget:"S",status:"available",tags:["gate","csi","coherence","drift"],adr:"ADR-029"},{id:"adversarial",name:"Adversarial-signal detector",category:"ais",crate:"wifi-densepose-wasm-edge",summary:"Physically-impossible-signal detector — multi-link consistency, used to flag spoofed CSI.",events:[3],budget:"M",status:"available",tags:["security","csi","spoofing","mesh"],adr:"ADR-032"},{id:"rvf",name:"RVF — Rust Verified Feature stream",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"Verified-frame builder with SHA-256 hash + version metadata for the feature stream.",budget:"S",status:"available",tags:["witness","csi","hash"],adr:"ADR-040"},{id:"occupancy",name:"Occupancy estimator",category:"bld",crate:"wifi-densepose-wasm-edge",summary:"Through-wall presence + person-count via CSI amplitude perturbation.",events:[300,301,302],budget:"S",status:"available",tags:["csi","building","presence"]},{id:"vital_trend",name:"Vital-trend monitor",category:"med",crate:"wifi-densepose-wasm-edge",summary:"HR + BR trend tracking with bradycardia/tachycardia/apnea events.",events:[100,101,102,103,104,105],budget:"S",status:"available",tags:["medical","vitals","csi"],adr:"ADR-021"},{id:"intrusion",name:"Intrusion detector",category:"sec",crate:"wifi-densepose-wasm-edge",summary:"Zone-based intrusion alert from CSI motion patterns.",events:[200,201],budget:"S",status:"available",tags:["security","zone","csi"]},{id:"med_sleep_apnea",name:"Sleep-apnea detector",category:"med",crate:"wifi-densepose-wasm-edge",summary:"Episodic respiratory pause detection during sleep cycles.",events:[105],budget:"S",status:"available",tags:["medical","sleep","breathing"]},{id:"med_cardiac_arrhythmia",name:"Cardiac arrhythmia",category:"med",crate:"wifi-densepose-wasm-edge",summary:"Beat-to-beat irregularity classifier from cardiac micro-Doppler.",events:[103,104],budget:"M",status:"available",tags:["medical","cardiac","arrhythmia"]},{id:"med_respiratory_distress",name:"Respiratory distress",category:"med",crate:"wifi-densepose-wasm-edge",summary:"Distress signature: rapid shallow breathing + accessory-muscle motion.",events:[101,102],budget:"S",status:"available",tags:["medical","breathing","icu"]},{id:"med_gait_analysis",name:"Gait analysis",category:"med",crate:"wifi-densepose-wasm-edge",summary:"Stride length, cadence, asymmetry from through-wall CSI pose tracking.",budget:"M",status:"available",tags:["medical","gait","pose"]},{id:"med_seizure_detect",name:"Seizure detector",category:"med",crate:"wifi-densepose-wasm-edge",summary:"Tonic-clonic seizure motion signature.",budget:"M",status:"beta",tags:["medical","neuro"]},{id:"sec_perimeter_breach",name:"Perimeter breach",category:"sec",crate:"wifi-densepose-wasm-edge",summary:"Approach/departure detection at user-defined boundary segments.",events:[210,211,212,213],budget:"S",status:"available",tags:["security","perimeter"]},{id:"sec_weapon_detect",name:"Metal anomaly / weapon",category:"sec",crate:"wifi-densepose-wasm-edge",summary:"Metal-perturbation flag in CSI; potential weapon presence (research).",events:[220,221,222],budget:"M",status:"research",tags:["security","metal","csi"]},{id:"sec_tailgating",name:"Tailgating detector",category:"sec",crate:"wifi-densepose-wasm-edge",summary:"Detect 2+ persons crossing a single-passage threshold.",events:[230,231,232],budget:"S",status:"available",tags:["security","access-control"]},{id:"sec_loitering",name:"Loitering detector",category:"sec",crate:"wifi-densepose-wasm-edge",summary:"Stationary occupancy past a configurable dwell threshold.",events:[240,241,242],budget:"S",status:"available",tags:["security","dwell"]},{id:"sec_panic_motion",name:"Panic motion",category:"sec",crate:"wifi-densepose-wasm-edge",summary:"High-energy distress motion: struggle / fleeing pattern.",events:[250,251,252],budget:"S",status:"beta",tags:["security","distress"]},{id:"bld_hvac_presence",name:"HVAC presence",category:"bld",crate:"wifi-densepose-wasm-edge",summary:"Occupied/activity-level/departure-countdown for HVAC zones.",events:[310,311,312],budget:"S",status:"available",tags:["hvac","building","energy"]},{id:"bld_lighting_zones",name:"Lighting zones",category:"bld",crate:"wifi-densepose-wasm-edge",summary:"Per-zone light on/dim/off cues from occupancy.",events:[320,321,322],budget:"S",status:"available",tags:["lighting","building"]},{id:"bld_elevator_count",name:"Elevator count",category:"bld",crate:"wifi-densepose-wasm-edge",summary:"Person count inside elevator car from CSI.",events:[330],budget:"S",status:"available",tags:["elevator","building"]},{id:"bld_meeting_room",name:"Meeting-room utilization",category:"bld",crate:"wifi-densepose-wasm-edge",summary:"Meeting size + duration analytics for booking systems.",budget:"S",status:"available",tags:["meeting","analytics"]},{id:"bld_energy_audit",name:"Energy audit",category:"bld",crate:"wifi-densepose-wasm-edge",summary:"Continuous occupancy-vs-HVAC-state audit for energy savings.",budget:"M",status:"available",tags:["energy","audit"]},{id:"ret_queue_length",name:"Queue length",category:"ret",crate:"wifi-densepose-wasm-edge",summary:"Live queue-length tracking for checkout / kiosks.",budget:"S",status:"available",tags:["retail","queue"]},{id:"ret_dwell_heatmap",name:"Dwell heatmap",category:"ret",crate:"wifi-densepose-wasm-edge",summary:"Per-zone dwell time accumulation; analytics-only export.",budget:"M",status:"available",tags:["retail","heatmap"]},{id:"ret_customer_flow",name:"Customer flow",category:"ret",crate:"wifi-densepose-wasm-edge",summary:"Origin-destination flow graph through a store layout.",budget:"M",status:"available",tags:["retail","flow"]},{id:"ret_table_turnover",name:"Table turnover",category:"ret",crate:"wifi-densepose-wasm-edge",summary:"Restaurant table seat / vacate transitions.",budget:"S",status:"available",tags:["retail","restaurant"]},{id:"ret_shelf_engagement",name:"Shelf engagement",category:"ret",crate:"wifi-densepose-wasm-edge",summary:"Reach-to-shelf gestures and dwell at product zones.",budget:"M",status:"available",tags:["retail","shelf"]},{id:"ind_forklift_proximity",name:"Forklift proximity",category:"ind",crate:"wifi-densepose-wasm-edge",summary:"Worker-near-forklift safety alert.",budget:"S",status:"available",tags:["industrial","safety"]},{id:"ind_confined_space",name:"Confined-space monitor",category:"ind",crate:"wifi-densepose-wasm-edge",summary:"Last-person-out detection + presence audit for OSHA confined-space entries.",budget:"S",status:"available",tags:["industrial","osha"]},{id:"ind_clean_room",name:"Clean-room PPE / motion",category:"ind",crate:"wifi-densepose-wasm-edge",summary:"Motion patterns consistent with proper PPE-clad movement.",budget:"M",status:"beta",tags:["industrial","cleanroom"]},{id:"ind_livestock_monitor",name:"Livestock monitor",category:"ind",crate:"wifi-densepose-wasm-edge",summary:"Vital-sign + activity tracking for stall-bound livestock.",budget:"M",status:"beta",tags:["agriculture","livestock"]},{id:"ind_structural_vibration",name:"Structural vibration",category:"ind",crate:"wifi-densepose-wasm-edge",summary:"Building/equipment micro-vibration via CSI phase derivative.",budget:"M",status:"research",tags:["industrial","vibration"]},{id:"sig_coherence_gate",name:"Coherence gate (extended)",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"Hysteresis + multi-state coherence gate driving downstream apps.",budget:"S",status:"available",tags:["gate","csi"]},{id:"sig_flash_attention",name:"Flash attention (CSI)",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"Edge-friendly attention block for CSI subcarrier weighting.",budget:"M",status:"beta",tags:["attention","csi"]},{id:"sig_temporal_compress",name:"Temporal-tensor compress",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"RuVector temporal-tensor compression on the CSI buffer.",budget:"M",status:"available",tags:["compress","tensor"]},{id:"sig_sparse_recovery",name:"Sparse recovery",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"114→56 subcarrier sparse interpolation via L1 solver.",budget:"M",status:"available",tags:["sparse","csi"]},{id:"sig_mincut_person_match",name:"Mincut person-match",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"Min-cut person assignment across multistatic frames.",budget:"M",status:"available",tags:["mincut","matching"]},{id:"sig_optimal_transport",name:"Optimal transport",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"OT-based feature alignment between mesh nodes.",budget:"M",status:"beta",tags:["ot","alignment"]},{id:"lrn_dtw_gesture_learn",name:"DTW gesture learn",category:"lrn",crate:"wifi-densepose-wasm-edge",summary:"On-device template learning for personalized gesture libraries.",budget:"M",status:"beta",tags:["lifelong","gesture"]},{id:"lrn_anomaly_attractor",name:"Anomaly attractor",category:"lrn",crate:"wifi-densepose-wasm-edge",summary:"Novelty detector with dynamic-attractor recall.",budget:"M",status:"research",tags:["novelty","lifelong"]},{id:"lrn_meta_adapt",name:"Meta-adapt",category:"lrn",crate:"wifi-densepose-wasm-edge",summary:"Meta-learning adapter for fast site-to-site transfer.",budget:"L",status:"research",tags:["meta-learning"]},{id:"lrn_ewc_lifelong",name:"EWC++ lifelong",category:"lrn",crate:"wifi-densepose-wasm-edge",summary:"Elastic-weight-consolidation gate to avoid catastrophic forgetting.",budget:"M",status:"beta",tags:["lifelong","ewc"]},{id:"spt_pagerank_influence",name:"PageRank influence",category:"spt",crate:"wifi-densepose-wasm-edge",summary:"Graph-influence ranking on the multistatic mesh.",budget:"M",status:"beta",tags:["graph","pagerank"]},{id:"spt_micro_hnsw",name:"µHNSW vector index",category:"spt",crate:"wifi-densepose-wasm-edge",summary:"Tiny HNSW index for AETHER re-ID embeddings on-device.",budget:"M",status:"available",tags:["hnsw","reid"]},{id:"spt_spiking_tracker",name:"Spiking tracker",category:"spt",crate:"wifi-densepose-wasm-edge",summary:"Spiking-network multi-target tracker.",budget:"L",status:"research",tags:["snn","tracker"]},{id:"tmp_pattern_sequence",name:"Pattern sequence",category:"tmp",crate:"wifi-densepose-wasm-edge",summary:"Sequence-of-events pattern matcher (e.g. ingress→linger→egress).",budget:"M",status:"available",tags:["temporal","pattern"]},{id:"tmp_temporal_logic_guard",name:"Temporal logic guard",category:"tmp",crate:"wifi-densepose-wasm-edge",summary:"LTL/MTL safety-property guard over event streams.",budget:"M",status:"beta",tags:["ltl","safety"]},{id:"tmp_goap_autonomy",name:"GOAP autonomy",category:"tmp",crate:"wifi-densepose-wasm-edge",summary:"Goal-oriented action planning for adaptive routines.",budget:"L",status:"research",tags:["planning","autonomy"]},{id:"ais_prompt_shield",name:"Prompt shield",category:"ais",crate:"wifi-densepose-wasm-edge",summary:"Edge-side LLM prompt-injection guard for on-device assistants.",budget:"M",status:"beta",tags:["security","llm"]},{id:"ais_behavioral_profiler",name:"Behavioral profiler",category:"ais",crate:"wifi-densepose-wasm-edge",summary:"Anomalous-behaviour profiler (drift in motion habits).",budget:"M",status:"beta",tags:["anomaly","behaviour"]},{id:"qnt_quantum_coherence",name:"Quantum coherence",category:"qnt",crate:"wifi-densepose-wasm-edge",summary:"Coherence diagnostics adapted for quantum-sensor signals.",budget:"M",status:"research",tags:["quantum","coherence"]},{id:"qnt_interference_search",name:"Interference search",category:"qnt",crate:"wifi-densepose-wasm-edge",summary:"Interferometric anomaly search across mesh viewpoints.",budget:"L",status:"research",tags:["quantum","interference"]},{id:"aut_psycho_symbolic",name:"Psycho-symbolic agent",category:"aut",crate:"wifi-densepose-wasm-edge",summary:"Symbolic-rule + neural-feature hybrid for low-power autonomy loops.",budget:"L",status:"research",tags:["autonomy","symbolic"]},{id:"aut_self_healing_mesh",name:"Self-healing mesh",category:"aut",crate:"wifi-densepose-wasm-edge",summary:"Mesh-topology repair with per-node health gossip.",budget:"M",status:"beta",tags:["mesh","health"]},{id:"exo_ghost_hunter",name:"Ghost hunter (anomaly)",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Empty-room CSI anomaly detector — impulsive/periodic/drift/random + hidden-presence sub-detector.",events:[650,651,652,653],budget:"S",status:"available",tags:["anomaly","paranormal","csi"],adr:"ADR-041"},{id:"exo_breathing_sync",name:"Breathing sync",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Multi-person breathing synchrony analytics.",budget:"M",status:"beta",tags:["breathing","sync"]},{id:"exo_dream_stage",name:"Dream-stage classifier",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"NREM/REM stage classification from breathing + micro-motion.",budget:"M",status:"research",tags:["sleep","rem"]},{id:"exo_emotion_detect",name:"Emotion detector",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Coarse arousal/valence from breathing + heart-rate variability.",budget:"M",status:"research",tags:["affect"]},{id:"exo_gesture_language",name:"Gesture language",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Sign-language pattern recognition.",budget:"L",status:"research",tags:["hci","sign"]},{id:"exo_happiness_score",name:"Happiness score",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Aggregate well-being score from co-occupancy + activity dynamics.",budget:"M",status:"research",tags:["affect","wellbeing"]},{id:"exo_hyperbolic_space",name:"Hyperbolic space embed",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Hyperbolic embeddings for hierarchical scene structure.",budget:"L",status:"research",tags:["embedding","hyperbolic"]},{id:"exo_music_conductor",name:"Music conductor",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Map gesture energy to MIDI tempo/dynamics.",budget:"M",status:"research",tags:["midi","art"]},{id:"exo_plant_growth",name:"Plant-growth tracker",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Slow CSI drift tracking for greenhouse foliage growth.",budget:"L",status:"research",tags:["agriculture"]},{id:"exo_rain_detect",name:"Rain detector",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Outdoor CSI signature of rainfall.",budget:"M",status:"research",tags:["weather"]},{id:"exo_time_crystal",name:"Time-crystal periodicity",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Periodicity diagnostics with anti-aliasing harmonics.",budget:"M",status:"research",tags:["periodicity"]}],oe={sim:{label:"Simulators",color:"oklch(0.78 0.14 70)",range:"—"},med:{label:"Medical & Health",color:"oklch(0.65 0.22 25)",range:"100–199"},sec:{label:"Security & Safety",color:"oklch(0.7 0.18 35)",range:"200–299"},bld:{label:"Smart Building",color:"oklch(0.78 0.12 195)",range:"300–399"},ret:{label:"Retail & Hospitality",color:"oklch(0.78 0.14 145)",range:"400–499"},ind:{label:"Industrial",color:"oklch(0.72 0.18 330)",range:"500–599"},sig:{label:"Signal Processing",color:"oklch(0.78 0.14 70)",range:"600–619"},lrn:{label:"Online Learning",color:"oklch(0.78 0.12 260)",range:"620–639"},spt:{label:"Spatial / Graph",color:"oklch(0.7 0.18 100)",range:"640–659"},tmp:{label:"Temporal / Planning",color:"oklch(0.7 0.16 50)",range:"660–679"},ais:{label:"AI Safety",color:"oklch(0.65 0.22 25)",range:"700–719"},qnt:{label:"Quantum",color:"oklch(0.72 0.18 290)",range:"720–739"},aut:{label:"Autonomy",color:"oklch(0.78 0.14 145)",range:"740–759"},exo:{label:"Exotic / Research",color:"oklch(0.72 0.18 330)",range:"650–699"}};function Et(){return ce.map(e=>({id:e.id,active:e.active===!0,eventCount:0}))}function Dt(e,t){if(!e)return 1;const a=e.toLowerCase();let i=0;return t.id.toLowerCase().includes(a)&&(i+=3),t.name.toLowerCase().includes(a)&&(i+=3),t.summary.toLowerCase().includes(a)&&(i+=1),t.tags?.some(s=>s.toLowerCase().includes(a))&&(i+=2),t.category===a&&(i+=5),i}const Ft="nvsim",Ot=1,te="kv";let we=null;function Ze(){return we||(we=new Promise((e,t)=>{const a=indexedDB.open(Ft,Ot);a.onupgradeneeded=()=>{const i=a.result;i.objectStoreNames.contains(te)||i.createObjectStore(te)},a.onsuccess=()=>e(a.result),a.onerror=()=>t(a.error)}),we)}async function H(e){const t=await Ze();return await new Promise((a,i)=>{const r=t.transaction(te,"readonly").objectStore(te).get(e);r.onsuccess=()=>a(r.result),r.onerror=()=>i(r.error)})}async function I(e,t){const a=await Ze();return await new Promise((i,s)=>{const r=a.transaction(te,"readwrite");r.objectStore(te).put(t,e),r.oncomplete=()=>i(),r.onerror=()=>s(r.error)})}var Ht=Object.defineProperty,It=Object.getOwnPropertyDescriptor,et=(e,t,a,i)=>{for(var s=i>1?void 0:i?It(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Ht(t,a,s),s};const N=p(Et()),ne=p(""),F=p("all"),S=p("all");(async()=>{const e=await H("app-activations");e&&(N.value=e)})();w(()=>{const e=N.value;e.length>0&&I("app-activations",e)});let ze=class extends y{constructor(){super(...arguments),this.renderTick=0}connectedCallback(){super.connectedCallback(),w(()=>{N.value,ne.value,F.value,S.value,this.renderTick++})}isActive(e){return N.value.find(t=>t.id===e)?.active===!0}toggle(e){const t=N.value.map(a=>a.id===e.id?{...a,active:!a.active,lastActivatedAt:Date.now()}:a);N.value=t,c(this.isActive(e.id)?"ok":"info",`app <span class="k">${e.id}</span> deactivated`)}filtered(){let e=ce;return F.value!=="all"&&(e=e.filter(t=>t.category===F.value)),S.value!=="all"&&(e=e.filter(t=>t.status===S.value)),ne.value.trim()&&(e=e.map(t=>({a:t,s:Dt(ne.value,t)})).filter(t=>t.s>0).sort((t,a)=>a.s-t.s).map(t=>t.a)),e}categoryCounts(){const e={all:ce.length};for(const t of Object.keys(oe))e[t]=0;for(const t of ce)e[t.category]=(e[t.category]??0)+1;return e}render(){const e=this.filtered(),t=this.categoryCounts(),a=N.value.filter(i=>i.active).length;return l`
      ...
      <div class="filters">
        ...
        ${Object.keys(oe).map(i=>l`
          <span class="chip ${F.value===i?"on":""}"
            @click=${()=>F.value=i}>
            <span class="swatch" style=${`background:${oe[i].color}`}></span>
            ${oe[i].label}
      ...
      ${e.length===0?l`<div class="empty">No apps match the current filters.</div>`:l`<div class="grid">${e.map(i=>this.card(i))}</div>`}
    `}card(e){const t=this.isActive(e.id),a=oe[e.category];return l`
      <div class="card ${t?"active":""}" data-app-id=${e.id}>
        ...
        <div class="meta">
          ...
          ${e.budget?l`<span class="badge budget">budget ${e.budget}</span>`:""}
          ${e.adr?l`<span class="badge">${e.adr}</span>`:""}
          ${e.events?.length?l`<span class="badge">events ${e.events.join("·")}</span>`:""}
        </div>
        <div class="card-foot">
  ...
  `;et([u()],ze.prototype,"renderTick",2);ze=et([x("nv-app-store")],ze);var Nt=Object.defineProperty,Wt=Object.getOwnPropertyDescriptor,fe=(e,t,a,i)=>{for(var s=i>1?void 0:i?Wt(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Nt(t,a,s),s};let U=class extends y{constructor(){super(...arguments),this.open=!1,this.filter="",this.idx=0,this.cmds=[{ico:"▶",label:"Run pipeline",kbd:"Space",run:async()=>{await b()?.run(),h.value=!0,C("Pipeline running","▶")}},{ico:"❚",label:"Pause pipeline",run:async()=>{await b()?.pause(),h.value=!1,C("Paused","❚❚")}},{ico:"+",label:"New scene…",kbd:"⌘N",run:()=>de({title:"New scene",body:`<p>Build a fresh magnetic scene. The dashboard generates the JSON
        ...
        </select>`,buttons:[{label:"Cancel",variant:"ghost"},{label:"Create",variant:"primary",onClick:async()=>{const e=document.querySelector("nv-app")?.shadowRoot?.querySelector("nv-modal")?.shadowRoot;if(!e)return;const t=(e.querySelector("#ns-name")?.value??"custom").trim(),a=parseFloat(e.querySelector("#ns-moment")?.value??"1e-6"),i=parseFloat(e.querySelector("#ns-distance")?.value??"0.5"),s=e.querySelector("#ns-ferrous")?.value==="1",r=e.querySelector("#ns-mains")?.value==="1",o={dipoles:[{position:[0,0,i],moment:[0,0,a]}],loops:r?[{centre:[0,1,0],normal:[0,1,0],radius:.05,current:2,n_segments:64}]:[],ferrous:s?[{position:[1,0,0],volume:1e-4,susceptibility:5e3}]:[],eddy:[],sensors:[[0,0,0]],ambient_field:[1e-6,0,0]};await b()?.loadScene(o),c("ok",`scene <span class="s">${t}</span> loaded · 1 dipole · ${r?"1 loop · ":""}${s?"1 ferrous · ":""}1 sensor`),C(`Scene "${t}" loaded`,"+")}}]})},{ico:"📦",label:"Export proof bundle…",kbd:"⌘E",run:async()=>{const e=b();if(e){c("dbg","building proof bundle…");try{const t=await e.exportProofBundle(),a=URL.createObjectURL(t),i=document.createElement("a");i.href=a,i.download=`nvsim-proof-${Date.now()}.json`,i.click(),URL.revokeObjectURL(a),c("ok",`proof bundle exported · ${t.size} bytes`),C(`Proof bundle saved (${t.size} B)`,"📦")}catch(t){c("err",`export failed: ${t.message}`)}}}},{ico:"⟳",label:"Reset pipeline",kbd:"⌘R",run:()=>de({title:"Reset pipeline?",body:"<p>Clears the frame stream and rewinds <code>t</code> to 0.</p>",buttons:[{label:"Cancel",variant:"ghost"},{label:"Reset",variant:"danger",onClick:async()=>{await b()?.reset(),c("warn","pipeline reset · t=0"),C("Pipeline reset","⟳")}}]})},{ico:"✓",label:"Verify witness",run:async()=>{const e=b();if(!e)return;$.value="pending";const t=R.value,a=new Uint8Array(32);for(let s=0;s<32;s++)a[s]=parseInt(t.slice(s*2,s*2+2),16);(await e.verifyWitness(a)).ok?($.value="ok",z.value=t,C("Witness verified","✓")):($.value="fail",C("Witness mismatch!","✗"))}},{ico:"☼",label:"Toggle theme",kbd:"⌘/",run:()=>{k.value=k.value==="dark"?"light":"dark"}},{ico:"⚙",label:"Open settings",kbd:"⌘,",run:()=>window.dispatchEvent(new CustomEvent("open-settings"))},{ico:"?",label:"Keyboard shortcuts…",run:()=>de({title:"Keyboard shortcuts",body:`<div style="display:grid;grid-template-columns:auto 1fr;gap:6px 16px;font-size:13px;">
      ...
      </div>`,buttons:[{label:"Close",variant:"primary"}]})},{ico:"i",label:"About nvsim…",run:()=>de({title:"About nvsim",body:`<p><b>nvsim</b> is a deterministic, byte-reproducible forward simulator for nitrogen-vacancy diamond magnetometry.</p>
        ...
        <div class="list">
          ${e.map((t,a)=>l`
            <div class="item ${a===this.idx?"active":""}" @click=${()=>{this.idx=a,this.runIdx()}}>
              ...
              ${t.kbd?l`<span class="kbd">${t.kbd}</span>`:""}
            </div>
          `)}
        </div>
      </div>
  ...
  `;fe([u()],U.prototype,"open",2);fe([u()],U.prototype,"filter",2);fe([u()],U.prototype,"idx",2);fe([Ye("#palette-input")],U.prototype,"inputEl",2);U=fe([x("nv-palette")],U);var Lt=Object.defineProperty,Bt=Object.getOwnPropertyDescriptor,Le=(e,t,a,i)=>{for(var s=i>1?void 0:i?Bt(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Lt(t,a,s),s};let me=class extends y{constructor(){super(...arguments),this.open=!1,this.renderFps=0,this.lastTs=performance.now(),this.frameCount=0,this.rafId=0,this.onKey=e=>{e.key==="`"&&!e.target.matches("input, textarea")&&(this.open=!this.open,this.toggleAttribute("open",this.open))},this.tick=()=>{this.rafId=requestAnimationFrame(this.tick);const e=performance.now();this.frameCount++,e-this.lastTs>=500&&(this.renderFps=this.frameCount*1e3/(e-this.lastTs),this.frameCount=0,this.lastTs=e,this.requestUpdate())}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKey),w(()=>{M.value,Ie.value,V.value,L.value,ut.value,this.requestUpdate()}),this.tick()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey),cancelAnimationFrame(this.rafId)}render(){return l`
      ...
      <div class="row"><span class="k">frames</span><span class="v">${Ie.value.toString()}</span></div>
      <div class="row"><span class="k">|B|</span><span class="v">${(V.value*1e9).toFixed(3)} nT</span></div>
      <div class="row"><span class="k">SNR</span><span class="v">${L.value>0?L.value.toFixed(1):"—"}</span></div>
    ...
    .k { color: var(--ink-3); }
    .v { color: var(--ink); }
  `;Le([u()],me.prototype,"open",2);Le([u()],me.prototype,"renderFps",2);me=Le([x("nv-debug-hud")],me);var qt=Object.defineProperty,Vt=Object.getOwnPropertyDescriptor,tt=(e,t,a,i)=>{for(var s=i>1?void 0:i?Vt(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&qt(t,a,s),s};let Te=class extends y{constructor(){super(...arguments),this.open=!1}connectedCallback(){super.connectedCallback(),w(()=>{k.value,_.value,T.value,re.value,A.value,Fe.value,this.requestUpdate()}),window.addEventListener("open-settings",()=>{this.open=!0,this.setAttribute("open","")})}close(){this.open=!1,this.removeAttribute("open")}async resetPrefs(){if(confirm("Reset all preferences and IndexedDB state? Reloads the page.")){try{const e=await indexedDB.databases?.();if(e)for(const t of e)t.name&&indexedDB.deleteDatabase(t.name)}catch{}location.reload()}}render(){return l`
      ...
      <div class="body">
        <div class="group">
          ...
          <div class="row">
            ...
            <div class="seg">
              <button class=${k.value==="dark"?"on":""}
                @click=${()=>k.value="dark"}>dark</button>
              <button class=${k.value==="light"?"on":""}
                @click=${()=>k.value="light"}>light</button>
            </div>
          </div>
          <div class="row">
            <div>
            ...
            <div class="seg">
              <button class=${_.value==="comfy"?"on":""}
                @click=${()=>_.value="comfy"}>comfy</button>
              <button class=${_.value==="default"?"on":""}
                @click=${()=>_.value="default"}>default</button>
              <button class=${_.value==="compact"?"on":""}
                @click=${()=>_.value="compact"}>compact</button>
            </div>
          </div>
          <div class="row">
            <div>
            ...
            <span class="toggle ${T.value?"on":""}"
              role="switch" aria-checked=${T.value}
              @click=${()=>T.value=!T.value}></span>
          </div>
        </div>
        ...
        <div class="group">
          ...
          <div class="row">
            ...
            <span class="toggle ${re.value?"on":""}"
              role="switch" aria-checked=${re.value}
              @click=${()=>re.value=!re.value}></span>
          </div>
        </div>
        ...
        <div class="group">
          ...
          ${A.value==="ws"?l`
            <div class="row">
              ...
              <input type="text" placeholder="ws://localhost:7878" .value=${Fe.value}
                @input=${e=>Fe.value=e.target.value} />
            </div>`:""}
        </div>
  ...
  `;tt([u()],Te.prototype,"open",2);Te=tt([x("nv-settings-drawer")],Te);var jt=Object.defineProperty,Ut=Object.getOwnPropertyDescriptor,Be=(e,t,a,i)=>{for(var s=i>1?void 0:i?Ut(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&jt(t,a,s),s};const O=[{icon:"👋",title:"Welcome to nvsim",body:`<p style="font-size:14px; line-height:1.6;">
      ...
      <p style="font-size:12.5px; color:var(--ink-3); line-height:1.55;">
        ...
        ADRs 089/090/091/092/093.</p>`,cta:{label:"Get started →"}}];let ge=class extends y{constructor(){super(...arguments),this.open=!1,this.step=0,this.show=()=>{this.step=0,this.open=!0,this.setAttribute("open","")}}async connectedCallback(){super.connectedCallback(),window.addEventListener("nv-show-tour",this.show),await H("onboarding-seen")||(this.open=!0,this.setAttribute("open",""))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("nv-show-tour",this.show)}async dismiss(){this.open=!1,this.removeAttribute("open"),await I("onboarding-seen",!0)}next(){O[this.step].cta?.run?.(),this.step<O.length-1?this.step++:this.dismiss()}prev(){this.step>0&&this.step--}render(){const e=O[this.step],t=this.step===O.length-1;return l`
      <div class="card" role="dialog" aria-modal="true" aria-label="Welcome tour">
        <div class="h">
          <div class="icon" aria-hidden="true">${e.icon}</div>
          <div class="title-wrap">
            <h2>${e.title}</h2>
            <div class="step-label">Step ${this.step+1} of ${O.length}</div>
          </div>
          <button class="skip" @click=${()=>this.dismiss()} aria-label="Skip tour" title="Skip tour">×</button>
        </div>
        <div class="body">
          <div .innerHTML=${e.body}></div>
          ${e.hint?l`<div class="hint">${e.hint}</div>`:""}
        </div>
        <div class="footer">
          <div class="progress">
            <div class="dots">
            ...
            <div class="progress-label">${this.step+1} / ${O.length}</div>
          </div>
          ${this.step>0?l`<button class="ghost" @click=${()=>this.prev()}>← Back</button>`:l`<button class="ghost" @click=${()=>this.dismiss()}>Skip</button>`}
    ...
    button.primary:hover { filter: brightness(1.08); }
  `;Be([u()],ge.prototype,"open",2);Be([u()],ge.prototype,"step",2);ge=Be([x("nv-onboarding")],ge);var Gt=Object.defineProperty,Kt=Object.getOwnPropertyDescriptor,ie=(e,t,a,i)=>{for(var s=i>1?void 0:i?Kt(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Gt(t,a,s),s};const Yt=[{id:"nvBest",label:"NV-ensemble (best lab)",floorT:1e-12,color:"oklch(0.78 0.14 70)"},{id:"nvCots",label:"NV-DNV-B1 (COTS)",floorT:3e-10,color:"oklch(0.72 0.18 50)"},{id:"squid",label:"SQUID (shielded room)",floorT:1e-15,color:"oklch(0.78 0.12 195)"},{id:"mmw",label:"60 GHz mmWave (μ-Doppler)",floorT:0,color:"oklch(0.78 0.14 145)"},{id:"csi",label:"WiFi CSI (presence)",floorT:0,color:"oklch(0.72 0.18 330)"}];let D=class extends y{constructor(){super(...arguments),this.distanceM=.1,this.momentLog10=-8.3,this.result=null,this.running=!1,this.err=null}predictedDipoleFieldT(e,t){return 4*Math.PI*1e-7*t/(4*Math.PI*Math.pow(Math.max(e,1e-6),3))}async runDemo(){const e=b();if(!e){this.err="WASM client not ready";return}this.err=null,this.running=!0,this.requestUpdate();try{const t=this.distanceM,a=Math.pow(10,this.momentLog10),i={dipoles:[{position:[0,0,t],moment:[0,0,a]}],loops:[],ferrous:[],eddy:[],sensors:[[0,0,0]],ambient_field:[0,0,0]},s={digitiser:{f_s_hz:1e4,f_mod_hz:1e3},sensor:{gamma_fwhm_hz:1e6,t1_s:.005,t2_s:1e-6,t2_star_s:2e-7,contrast:.03,n_spins:1e12,shot_noise_disabled:!1},dt_s:null};this.result=await e.runTransient(i,s,42n,64),c("ok",`ghost-demo · r=${t.toFixed(3)} m · |B| recovered = ${(this.result.bMagT*1e12).toExponential(2)} pT`)}catch(t){this.err=t.message,c("err",`ghost-demo failed: ${this.err}`)}finally{this.running=!1,this.requestUpdate()}}formatField(e){if(e===0)return"0 T";const t=Math.abs(e);return t>=.001?`${(e*1e3).toFixed(2)} mT`:t>=1e-6?`${(e*1e6).toFixed(2)} µT`:t>=1e-9?`${(e*1e9).toFixed(3)} nT`:t>=1e-12?`${(e*1e12).toFixed(2)} pT`:t>=1e-15?`${(e*1e15).toFixed(2)} fT`:t>=1e-18?`${(e*1e18).toFixed(2)} aT`:`${e.toExponential(2)} T`}formatDistance(e){return e<1?`${(e*100).toFixed(1)} cm`:e<1e3?`${e.toFixed(2)} m`:e<1e5?`${(e/1e3).toFixed(2)} km`:`${(e/1609).toFixed(0)} mi`}renderDemo(){const e=Math.pow(10,this.momentLog10),t=this.predictedDipoleFieldT(this.distanceM,e),a=this.result?.bMagT??0,i=(this.result?.noiseFloorPtSqrtHz??0)*1e-12,s=Yt.map(n=>{let d="bad",v="below floor";if(n.id==="mmw")this.distanceM<=5?(d="ok",v="µ-Doppler @ chest"):this.distanceM<=15?(d="warn",v="edge of range"):(d="bad",v="out of range");else if(n.id==="csi")this.distanceM<=30?(d=this.distanceM<=10?"ok":"warn",v="presence/breathing"):(d="bad",v="out of range");else if(n.floorT>0){const g=t/n.floorT;g>100?(d="ok",v=`${g.toExponential(1)}× floor`):g>1?(d="warn",v=`${g.toFixed(1)}× floor`):(d="bad",v=`${(1/g).toExponential(1)}× too weak`)}const m=n.floorT>0?Math.max(2,Math.min(100,100+12*Math.log10(t/n.floorT))):n.id==="mmw"?Math.max(2,100-this.distanceM*7):Math.max(2,100-this.distanceM*2);return l`
        <div class="tier-bar" data-tier=${n.id}>
          <div class="fill" style=${`width:${m}%; background:${n.color}; border-color:${n.color}`}></div>
          <div class="lbl">
            <span>${n.label}</span>
            <span class="verdict-${d}" style=${`color:${d==="ok"?"var(--ok)":d==="warn"?"var(--warn)":"var(--bad)"}`}>${v}</span>
          </div>
        </div>
      `}),r=t>1e-12?"ok":t>1e-15?"warn":"bad",o=r==="ok"?`Above NV-ensemble lab floor — close-range MCG plausible at ${this.formatDistance(this.distanceM)}.`:r==="warn"?`Below NV ensemble best, above SQUID — research-grade only at ${this.formatDistance(this.distanceM)}.`:`Below every published instrument's noise floor at ${this.formatDistance(this.distanceM)}. Press-release physics.`;return l`
      <div class="demo">
        ...
        <div class="demo-grid">
          <div>
            ...
            ${this.err?l`<div class="verdict bad" style="margin-top: 10px;">Error: ${this.err}</div>`:""}
          </div>
        ...
        <div class="verdict ${r}" id="demo-verdict">${o}</div>
  ...
  `;ie([u()],D.prototype,"distanceM",2);ie([u()],D.prototype,"momentLog10",2);ie([u()],D.prototype,"result",2);ie([u()],D.prototype,"running",2);ie([u()],D.prototype,"err",2);D=ie([x("nv-ghost-murmur")],D);var Xt=Object.defineProperty,Qt=Object.getOwnPropertyDescriptor,Re=(e,t,a,i)=>{for(var s=i>1?void 0:i?Qt(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&Xt(t,a,s),s};const je=[{term:"NV-diamond",category:"physics",body:"Nitrogen-vacancy defect in synthetic diamond. The simulator models a 1 mm³ ensemble (~10¹² centers) addressed by 532 nm pump light + a 2.87 GHz microwave drive. Used as a room-temperature magnetometer with shot-noise floor ~1 pT/√Hz at the published lab record."},{term:"CW-ODMR",category:"physics",body:"Continuously-driven optically-detected magnetic resonance. Sweep the microwave frequency around the NV zero-field splitting (D = 2.87 GHz) and watch the photoluminescence dip when the microwave matches the spin transition. The dip splits with applied magnetic field along each of the four ⟨111⟩ NV axes."},{term:"MagFrame",category:"rust",body:"Fixed-layout 60-byte binary record nvsim emits per (sensor × sample). Magic 0xC51A_6E70, version 1, little-endian. Carries timestamp, recovered B vector (pT), per-axis sigma, noise floor, and flag bits for saturation / shot-noise-disabled / heavy-attenuation."},{term:"Witness",category:"rust",body:"SHA-256 hash over the concatenated MagFrame bytes for a canonical reference run (Proof::REFERENCE_SCENE_JSON @ seed=42, N=256). Same inputs → same hash, byte-for-byte, across runs and machines. The dashboard re-derives it in WASM and compares against Proof::EXPECTED_WITNESS_HEX pinned at build time."},{term:"Determinism gate",category:"rust",body:"A pass/fail check: did this build of nvsim produce the expected witness? If yes → every constant (γ_e, D_GS, μ₀, contrast, T₂*, the PRNG stream, the frame layout, the pipeline ordering) is byte-identical to the published reference. If no → something drifted; the dashboard names which."},{term:"Lock-in demod",category:"physics",body:"Multiply the photoluminescence signal by cos(2π·f_mod·t) and low-pass to recover the slowly-varying B-field component. The simulator emulates a lock-in with output gain 2 and a single-pole IIR LP filter; settable via the Tunables panel (f_mod default 1 kHz)."},{term:"Shot-noise floor",category:"physics",body:'δB = 1 / (γ_e · C · √(N · t · T₂*)) — the irreducible quantum noise floor for an NV ensemble. With nvsim defaults (N=10¹², C=0.03, T₂*=200 ns): ≈1.18 pT/√Hz. Toggleable via the Tunables panel for "analytic" runs without noise.'},{term:"Biot-Savart",category:"physics",body:"Closed-form magnetic field at a point from a current loop or a magnetic dipole. The Scene panel's sources (heart proxy, mains loop, ferrous body, eddy current) all reduce to Biot-Savart-style superpositions over the sensor position."},{term:"Multistatic fusion",category:"physics",body:"Combining evidence from multiple sensors at known geometric configurations. RuView's Cramer-Rao-weighted attention over WiFi CSI nodes + 60 GHz radar nodes + (hypothetically) NV nodes; documented in ADR-029 and the Ghost Murmur view."},{term:"Scene",category:"ui",body:'The simulated magnetic environment: a list of sources (dipole, current loop, ferrous body, eddy current) plus one or more sensor positions and an ambient field. The dashboard ships a "rebar-walkby-01" reference scene; click "New scene…" in the command palette (⌘K) to build your own.'},{term:"Tunables",category:"ui",body:"Sliders that change the running pipeline's digitiser config. Each edit debounces 300 ms, then rebuilds the WASM pipeline with the new f_s / f_mod / dt / shot-noise setting. The frame stream picks up the change without a restart."},{term:"Transport",category:"ui",body:"How the dashboard talks to nvsim. Default is WASM — the simulator runs in a Web Worker right here in your browser, no server. The optional WS transport is REST + binary WebSocket against a host-supplied nvsim-server (see ADR-092 §6.2). Toggle in Settings."},{term:"App Store",category:"ui",body:"Catalog of all 65+ hot-loadable WASM edge modules from wifi-densepose-wasm-edge plus the simulators. Each card carries id / category / status / event IDs; the toggle marks an app active in this session and (in WS mode) pushes the activation to a connected ESP32 mesh."},{term:"Ghost Murmur",category:"ui",body:'Research view that audits the publicly-reported April 2026 CIA NV-diamond heartbeat detector against the open physics literature. Includes a live "Try it yourself" sandbox where you can place a heart dipole at any distance from the sensor and ask: which transport tier would actually detect it?'}],Jt=[{q:"Is this a real simulator or a mockup?",a:"Real. The Rust crate at v2/crates/nvsim is the same code that runs in the browser via WASM. Press <b>Verify witness</b> on the Witness panel — the SHA-256 you see is byte-equivalent to what `cargo test -p nvsim` produces."},{q:'Why does my "Recovered |B|" sit much higher than "Predicted |B|" in the Ghost Murmur demo?',a:"The recovered value reads the simulator's ADC quantization floor, not the actual magnetic signal. With COTS-default sensor noise (~300 pT/√Hz) and 16-bit ADC at ±10 µT FS, anything below ~1 pT vanishes into ~2 nT of digitization residual. That's the lesson — the press claim sits far below this floor at any meaningful range."},{q:"Can I run my own scene?",a:'Yes. Press ⌘K to open the command palette and pick "New scene…". You get five fields (name, dipole moment, distance, ferrous toggle, mains toggle); the dashboard builds the JSON and pushes it via <code>client.loadScene()</code>.'},{q:"Does any of my data leave the browser?",a:"No. WASM mode is local-only — the worker, the WASM binary, and the IndexedDB persistence all live in your browser. The optional WS transport (off by default) talks to a host of your choosing."},{q:"What does the witness mismatch (red ✗) mean?",a:"The current build of nvsim produced a SHA-256 that doesn't match the constant pinned at compile time. Possible causes: a different Rust toolchain, a dependency version drift, a manual edit to a physics constant, or an honest bug. Audit the diff against ADR-089 §5."},{q:"Why are the Inspector / Witness rail buttons there if there's already a right-side inspector?",a:'The right-side inspector is the compact live view; the rail buttons open a full-width version with bigger charts, an explainer header, reference-scene metadata cards, and (on Witness) a "what this verifies" panel. Both stay in sync — the right rail is for glancing, the main area is for diving in.'},{q:'Why is there an "App Store" if this is a magnetometer simulator?',a:"Because nvsim is one tile in a larger sensing platform. The catalog lists every hot-loadable WASM edge module RuView ships — medical, security, building, retail, industrial, signal, learning, autonomy. The simulators (nvsim today, more in future) are first-class entries in the same catalog."}],Zt=[{step:1,title:"Hit ▶ Run",body:"The big amber button in the topbar starts the live frame stream. The pipeline runs ~1.8 kHz on x86_64 WASM, well above the 1 kHz Cortex-A53 acceptance gate."},{step:2,title:"Watch the B-vector trace",body:"The Inspector → Signal tab shows the recovered field per axis updating in real time. The frame strip below it is one bar per ~32-frame batch."},{step:3,title:"Verify the witness",body:"Click the rail Witness button (or REPL: <code>proof.verify</code>). The dashboard re-runs the canonical reference scene and asserts the SHA-256 byte-for-byte."},{step:4,title:"Drag a source",body:"Grab the rebar / heart proxy / mains loop / ferrous door in the scene canvas; positions persist via IndexedDB."},{step:5,title:"Tweak the tunables",body:"Sliders in the left sidebar update the running pipeline (f_s, f_mod, integration time, shot-noise). Changes debounce 300 ms then push to the worker."},{step:6,title:"Open the Ghost Murmur view",body:'The ghost icon in the rail. Move the distance + moment sliders, hit "Run nvsim at this distance" — the live demo runs the real Rust pipeline through WASM and shows which transport tier would actually detect.'},{step:7,title:"Browse the App Store",body:"The grid icon. 65+ edge apps: medical, security, building, retail, industrial, signal, learning. Toggle to mark active in this session."}],ea=[{keys:"⌘K  /  Ctrl K",label:"Command palette"},{keys:"Space",label:"Play / pause pipeline"},{keys:"⌘R  /  Ctrl R",label:"Reset pipeline (with confirm)"},{keys:"⌘,  /  Ctrl ,",label:"Settings drawer"},{keys:"⌘N  /  Ctrl N",label:"New scene"},{keys:"⌘E  /  Ctrl E",label:"Export proof bundle"},{keys:"⌘/  /  Ctrl /",label:"Toggle theme (dark / light)"},{keys:"`",label:"Toggle debug HUD"},{keys:"?",label:"Open this help center"},{keys:"1 · 2 · 3",label:"Switch inspector tab (Signal / Frame / Witness)"},{keys:"Esc",label:"Close any modal / palette / drawer"},{keys:"/",label:"Focus the REPL prompt"}];let ae=class extends y{constructor(){super(...arguments),this.open=!1,this.section="quickstart",this.query="",this.show=e=>{const t=e.detail;t?.section&&(this.section=t.section),this.open=!0,this.setAttribute("open","")},this.onKey=e=>{const t=e.target,a=t?.tagName==="INPUT"||t?.tagName==="TEXTAREA";e.key==="?"&&!a&&!e.ctrlKey&&!e.metaKey?(e.preventDefault(),this.show(new CustomEvent("nv-show-help"))):e.key==="Escape"&&this.open&&this.close()}}connectedCallback(){super.connectedCallback(),window.addEventListener("nv-show-help",this.show),window.addEventListener("keydown",this.onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("nv-show-help",this.show),window.removeEventListener("keydown",this.onKey)}close(){this.open=!1,this.removeAttribute("open")}filteredGlossary(){if(!this.query.trim())return je;const e=this.query.toLowerCase();return je.filter(t=>t.term.toLowerCase().includes(e)||t.body.toLowerCase().includes(e))}renderQuickstart(){return l`
      ...
      `)}
    `}renderGlossary(){const e=this.filteredGlossary();return l`
      <h2>Glossary</h2>
      ...
      ${e.length===0?l`<p style="color: var(--ink-3);">No terms match.</p>`:e.map(t=>l`
            <div class="term">
              <div class="head">
    ...
    `}render(){return l`
      <div class="modal" role="dialog" aria-modal="true" aria-label="Help center">
        ...
        <nav class="nav" role="tablist" aria-label="Help sections">
          ${["quickstart","glossary","faq","shortcuts","about"].map(e=>l`
  ...
  `;Re([u()],ae.prototype,"open",2);Re([u()],ae.prototype,"section",2);Re([u()],ae.prototype,"query",2);ae=Re([x("nv-help")],ae);var ta=Object.defineProperty,aa=Object.getOwnPropertyDescriptor,at=(e,t,a,i)=>{for(var s=i>1?void 0:i?aa(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&ta(t,a,s),s};let Me=class extends y{constructor(){super(...arguments),this.view="scene"}render(){return l`
      ...
      <div class="app">
        ...
        <main class="main" id="main-content" tabindex="-1" role="main" aria-label="Main view">
          ${this.view==="apps"?l`<nv-app-store></nv-app-store>`:this.view==="ghost-murmur"?l`<nv-ghost-murmur></nv-ghost-murmur>`:this.view==="inspector"?l`<nv-inspector expanded .pinTab=${"signal"}></nv-inspector>`:this.view==="witness"?l`<nv-inspector expanded .pinTab=${"witness"}></nv-inspector>`:l`<nv-scene></nv-scene>`}
        </main>
        <nv-inspector
  ...
  `;at([u()],Me.prototype,"view",2);Me=at([x("nv-app")],Me);function sa(e,t,a){const i=e.getUint32(t+0,!0),s=e.getUint16(t+4,!0),r=e.getUint16(t+6,!0),o=e.getUint16(t+8,!0),n=e.getBigUint64(t+12,!0),d=e.getFloat32(t+20,!0),v=e.getFloat32(t+24,!0),m=e.getFloat32(t+28,!0),g=e.getFloat32(t+32,!0),G=e.getFloat32(t+36,!0),Ee=e.getFloat32(t+40,!0),De=e.getFloat32(t+44,!0),st=e.getFloat32(t+48,!0);return{magic:i,version:s,flags:r,sensorId:o,tUs:n,bPt:[d,v,m],sigmaPt:[g,G,Ee],noiseFloorPtSqrtHz:De,temperatureK:st,raw:a.subarray(t,t+60)}}function ia(e){const a=new DataView(e.buffer,e.byteOffset,e.byteLength),i=[];for(let s=0;s+60<=e.byteLength;s+=60)i.push(sa(a,s,e));return i}class ra{constructor(){this.nextId=1,this.pending=new Map,this.frameSubs=new Set,this.eventSubs=new Set,this.bootInfo=null,this.worker=new Worker(new URL("/RuView/nvsim/assets/worker-C19MRcXs.js",import.meta.url),{type:"module"}),this.worker.addEventListener("message",t=>this.onMessage(t)),this.worker.addEventListener("error",t=>this.eventSubs.forEach(a=>a({type:"log",level:"err",msg:String(t.message)})))}onMessage(t){const a=t.data;if(a.type==="frames"){const i=a.batch,s=new Uint8Array(i),o={frames:ia(s),bytes:s};this.frameSubs.forEach(d=>d(o));const n=a.fps;n>0&&this.eventSubs.forEach(d=>d({type:"fps",value:n}));return}if(a.type==="state"){this.eventSubs.forEach(i=>i({type:"state",running:!!a.running,t:0,framesEmitted:Number(a.framesEmitted??0)}));return}if(a.type!=="ready"){if(a.type==="err"&&a.id==null){this.eventSubs.forEach(i=>i({type:"log",level:"err",msg:String(a.msg)}));return}if(typeof a.id=="number"&&this.pending.has(a.id)){const i=this.pending.get(a.id);this.pending.delete(a.id),a.type==="err"?i.reject(new Error(String(a.msg))):i.resolve(a)}}}rpc(t,a=[]){const i=this.nextId++;return new Promise((s,r)=>{this.pending.set(i,{resolve:s,reject:r}),this.worker.postMessage({...t,id:i},a)})}async boot(){if(this.bootInfo)return this.bootInfo;const a=await this.rpc({type:"boot",base:"/RuView/nvsim/"});return this.bootInfo={buildVersion:a.buildVersion,frameMagic:a.frameMagic,frameBytes:a.frameBytes,expectedWitnessHex:a.expectedWitnessHex},this.bootInfo}async loadScene(t){await this.rpc({type:"setScene",json:JSON.stringify(t)})}async setConfig(t){await this.rpc({type:"setConfig",json:JSON.stringify(t)})}async setSeed(t){await this.rpc({type:"setSeed",seed:Number(t&0xFFFFFFFFn)})}async reset(){await this.rpc({type:"reset"})}async run(t){await this.rpc({type:"run"})}async pause(){await this.rpc({type:"pause"})}async step(t,a){await this.rpc({type:"step"})}onFrames(t){this.frameSubs.add(t)}onEvent(t){this.eventSubs.add(t)}async generateWitness(t){const a=await this.rpc({type:"witnessGenerate",samples:t});return new Uint8Array(a.witness)}async verifyWitness(t){const a=t.slice().buffer,i=await this.rpc({type:"witnessVerify",samples:256,expected:a},[a]);return i.ok?{ok:!0}:{ok:!1,actual:new Uint8Array(i.actual)}}async runTransient(t,a,i,s){const r=await this.rpc({type:"runTransient",scene:JSON.stringify(t),config:JSON.stringify(a),seed:Number(i&0xFFFFFFFFn),samples:s});return{bRecoveredT:[r.bRecoveredT[0],r.bRecoveredT[1],r.bRecoveredT[2]],bMagT:r.bMagT,noiseFloorPtSqrtHz:r.noiseFloorPtSqrtHz,sigmaPt:[r.sigmaPt[0],r.sigmaPt[1],r.sigmaPt[2]],nFrames:r.nFrames,witnessHex:r.witnessHex}}async exportProofBundle(){const t=await this.generateWitness(256),a=Array.from(t).map(r=>r.toString(16).padStart(2,"0")).join(""),i=this.bootInfo??await this.boot(),s=JSON.stringify({kind:"nvsim-proof-bundle",version:i.buildVersion,seed:"0x0000002A",nSamples:256,witness:a,expected:i.expectedWitnessHex,ok:a===i.expectedWitnessHex,ts:new Date().toISOString()},null,2);return new Blob([s],{type:"application/json"})}async buildId(){return(await this.rpc({type:"buildId"})).buildId}async close(){this.worker.terminate()}}function Ue(e){document.documentElement.setAttribute("data-theme",e)}function Ge(e){document.body.classList.remove("density-comfy","density-default","density-compact"),document.body.classList.add(`density-${e}`)}function Ke(e){document.body.classList.toggle("reduce-motion",e)}(async()=>{const e=await H("theme")??"dark",t=await H("density")??"default",a=window.matchMedia?.("(prefers-reduced-motion: reduce)").matches??!1,i=await H("motionReduced")??a;k.value=e,Ue(e),_.value=t,Ge(t),T.value=i,Ke(i),w(()=>{Ue(k.value),I("theme",k.value)}),w(()=>{Ge(_.value),I("density",_.value)}),w(()=>{Ke(T.value),I("motionReduced",T.value)});const s=await H("repl-history");s&&Array.isArray(s)&&(q.value=s),w(()=>{I("repl-history",q.value)});const r=await H("scene-positions");r&&Array.isArray(r)&&(ve.value=r),w(()=>{I("scene-positions",ve.value)});const o=new ra;mt(o),c("info","nvsim — booting WASM runtime"),o.onEvent(n=>{n.type==="log"&&c(n.level,n.msg),n.type==="fps"&&(M.value=n.value),n.type==="state"&&(Ie.value=BigInt(n.framesEmitted))}),o.onFrames(n=>{if(n.frames.length===0)return;const d=n.frames[n.frames.length-1];B.value=d;const v=d.bPt[0]*1e-12,m=d.bPt[1]*1e-12,g=d.bPt[2]*1e-12;he.value=[v,m,g],V.value=Math.sqrt(v*v+m*m+g*g),bt([v*1e9,m*1e9,g*1e9]);const G=Math.min(1,Math.abs(g*1e9)/5+.3);ft(G)});try{const n=await o.boot();R.value=n.expectedWitnessHex,c("ok",`WASM module ready · nvsim@${n.buildVersion} · magic=0x${n.frameMagic.toString(16).toUpperCase()}`),c("info",`expected witness · ${n.expectedWitnessHex.slice(0,16)}…`),vt.value="(reference scene)",A.value="wasm"}catch(n){c("err",`boot failed: ${n.message}`)}try{const n=R.value;if(n){const d=new Uint8Array(32);for(let m=0;m<32;m++)d[m]=parseInt(n.slice(m*2,m*2+2),16);const v=await o.verifyWitness(d);if(v.ok)z.value=n,c("ok","witness verified · determinism gate ✓");else{const m=Array.from(v.actual).map(g=>g.toString(16).padStart(2,"0")).join("");z.value=m,c("err",`WITNESS MISMATCH · expected ${n.slice(0,16)}… got ${m.slice(0,16)}…`)}}}catch(n){c("warn",`witness verify skipped: ${n.message}`)}})();
//# sourceMappingURL=index-DgoW5uYG.js.map
