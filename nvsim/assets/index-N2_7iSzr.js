import{f as At,u as Ct,i as y,a as x,b as o,w as le}from"./lit-BS7WqYd5.js";import{y as p,g as Et,j as g}from"./signals-SG45zFCj.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();/**
 * @license
 ...
 */function mt(e,t){return(a,s,i)=>{const r=n=>n.renderRoot?.querySelector(e)??null;return Dt(a,s,{get(){return r(this)}})}}var It=Object.defineProperty,Ft=Object.getOwnPropertyDescriptor,gt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ft(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&It(t,a,i),i};let He=class extends x{constructor(){super(...arguments),this.view="scene"}navigate(e){this.dispatchEvent(new CustomEvent("navigate",{detail:e}))}render(){return o`
  ...
  `;Ee([u()],Z.prototype,"open",2);Ee([u()],Z.prototype,"mTitle",2);Ee([u()],Z.prototype,"mBody",2);Ee([u()],Z.prototype,"buttons",2);Z=Ee([w("nv-modal")],Z);function ke(e){window.dispatchEvent(new CustomEvent("nv-modal",{detail:e}))}var Gt=Object.defineProperty,Kt=Object.getOwnPropertyDescriptor,Ke=(e,t,a,s)=>{for(var i=s>1?void 0:s?Kt(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Gt(t,a,i),i};let de=class extends x{constructor(){super(...arguments),this.visible=!1,this.msg="",this.icon="✓",this.timer=null,this.onToast=e=>{const t=e.detail;this.msg=t.msg??"Done",this.icon=t.icon??"✓",this.visible=!0,this.setAttribute("visible",""),this.timer!==null&&window.clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this.visible=!1,this.removeAttribute("visible")},1800)}}connectedCallback(){super.connectedCallback(),window.addEventListener("nv-toast",this.onToast)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("nv-toast",this.onToast)}render(){return o`<span class="icon">${this.icon}</span><span>${this.msg}</span>`}};de.styles=y`
    :host {
  ...
  `;Ke([u()],de.prototype,"visible",2);Ke([u()],de.prototype,"msg",2);Ke([u()],de.prototype,"icon",2);de=Ke([w("nv-toast")],de);function W(e,t="✓"){window.dispatchEvent(new CustomEvent("nv-toast",{detail:{msg:e,icon:t}}))}var Yt=Object.getOwnPropertyDescriptor,Qt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Yt(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(i)||i);return i};let tt=class extends x{connectedCallback(){super.connectedCallback(),g(()=>{_.value,ct.value,K.value,$.value,dt.value,m.value,this.requestUpdate()})}async toggleRun(){const e=f();e&&(m.value?(await e.pause(),m.value=!1):(await e.run(),m.value=!0))}async reset(){const e=f();e&&await e.reset()}toggleTheme(){$.value=$.value==="dark"?"light":"dark"}async openSeedModal(){const e=`0x${K.value.toString(16).toUpperCase().padStart(8,"0")}`;ke({title:"Set seed",body:`<p>Set the 32-bit hex seed for the shot-noise PRNG. Same <code>(scene, config, seed)</code> → byte-identical witness.</p>
  ...
  `;at=Jt([w("nv-sidebar")],at);var Zt=Object.defineProperty,ea=Object.getOwnPropertyDescriptor,ve=(e,t,a,s)=>{for(var i=s>1?void 0:s?ea(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Zt(t,a,i),i};let q=class extends x{constructor(){super(...arguments),this.zoom=1,this.layerVisible={source:!0,field:!0,label:!0},this.items=[{id:"rebar",x:740,y:240,color:"oklch(0.72 0.18 330)",name:"rebar.steel"},{id:"heart",x:220,y:180,color:"oklch(0.78 0.14 195)",name:"heart_proxy"},{id:"mains",x:180,y:380,color:"oklch(0.72 0.18 330)",name:"mains_60Hz"},{id:"door",x:800,y:470,color:"oklch(0.78 0.14 145)",name:"door.steel"}],this.dragging=null,this.selected=null,this.dragOffset={dx:0,dy:0},this.onDown=(e,t)=>{t.preventDefault(),this.dragging=e,this.selected=e;const a=this.items.find(r=>r.id===e);if(!a)return;const s=this.renderRoot.querySelector("svg");if(!s)return;const i=this.toSvg(t,s);this.dragOffset={dx:i.x-a.x,dy:i.y-a.y}},this.onPointerMove=e=>{if(!this.dragging)return;const t=this.renderRoot.querySelector("svg");if(!t)return;const a=this.toSvg(e,t);this.items=this.items.map(s=>s.id===this.dragging?{...s,x:a.x-this.dragOffset.dx,y:a.y-this.dragOffset.dy}:s)},this.onPointerUp=()=>{this.dragging&&(Te.value=this.items.map(({id:e,x:t,y:a})=>({id:e,x:t,y:a}))),this.dragging=null}}connectedCallback(){super.connectedCallback(),Te.value.length>0&&(this.items=this.items.map(e=>{const t=Te.value.find(a=>a.id===e.id);return t?{...e,x:t.x,y:t.y}:e})),g(()=>{ze.value,J.value,_.value,Y.value,D.value,m.value,Ie.value,Q.value,this.requestUpdate()}),g(()=>{const e=Q.value;if(!e)return;const t=Math.sqrt(e.bPt[0]**2+e.bPt[1]**2+e.bPt[2]**2),a=Math.max(Math.abs(e.sigmaPt[0]),Math.abs(e.sigmaPt[1]),Math.abs(e.sigmaPt[2]),.001),s=t/a;Number.isFinite(s)&&(Y.value=s)}),window.addEventListener("pointermove",this.onPointerMove),window.addEventListener("pointerup",this.onPointerUp)}async toggleRun(){const e=f();e&&(m.value?(await e.pause(),m.value=!1):(await e.run(),m.value=!0))}async stepFwd(){const e=f();e&&(await e.step("fwd",10),c("dbg","sim step → +1 frame"))}async stepBack(){const e=f();e&&(await e.step("back",10),c("dbg","sim step ← -1 frame"))}cycleSpeed(){const e=[.25,.5,1,2,4],t=e.indexOf(Ie.value);Ie.value=e[(t+1)%e.length]}zoomIn(){this.zoom=Math.min(2.5,this.zoom*1.2)}zoomOut(){this.zoom=Math.max(.5,this.zoom/1.2)}fitView(){this.zoom=1}toggleLayer(e){this.layerVisible={...this.layerVisible,[e]:!this.layerVisible[e]}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("pointermove",this.onPointerMove),window.removeEventListener("pointerup",this.onPointerUp)}toSvg(e,t){const a=t.getBoundingClientRect(),s=(e.clientX-a.left)/a.width*1e3,i=(e.clientY-a.top)/a.height*600;return{x:s,y:i}}render(){const e=ze.value,t=[e[0]*1e9,e[1]*1e9,e[2]*1e9],a=J.value*1e9,s=D.value?"":"anim",i=1e3/this.zoom,r=600/this.zoom,n=(1e3-i)/2,l=(600-r)/2;return o`
      ...
      <svg viewBox="${n.toFixed(1)} ${l.toFixed(1)} ${i.toFixed(1)} ${r.toFixed(1)}"
        ...
        ${this.layerVisible.field?this.items.map(d=>le`
        ...
        <!-- Source primitives -->
        ${this.layerVisible.source?this.items.map(d=>le`
          <g class=${`draggable ${this.dragging===d.id?"dragging":""} ${this.selected===d.id?"selected":""}`}
            ...
            ${this.layerVisible.label?le`<text class="label" x="0" y="40" text-anchor="middle">${d.name}</text>`:""}
          </g>
        `):""}
  ...
  `;ve([u()],q.prototype,"zoom",2);ve([u()],q.prototype,"layerVisible",2);ve([u()],q.prototype,"items",2);ve([u()],q.prototype,"dragging",2);ve([u()],q.prototype,"selected",2);q=ve([w("nv-scene")],q);var ta=Object.defineProperty,aa=Object.getOwnPropertyDescriptor,Ye=(e,t,a,s)=>{for(var i=s>1?void 0:s?aa(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ta(t,a,i),i};let ce=class extends x{constructor(){super(...arguments),this.tab="signal",this.pinTab=null,this.expanded=!1}connectedCallback(){super.connectedCallback(),g(()=>{Se.value,Ne.value,Le.value,_e.value,Q.value,R.value,S.value,ze.value,J.value,this.requestUpdate()})}willUpdate(e){e.has("pinTab")&&this.pinTab&&this.tab!==this.pinTab&&(this.tab=this.pinTab)}async verify(){const e=f();if(e){S.value="pending",c("info","verifying witness over 256 frames…");try{const t=N.value,a=new Uint8Array(32);for(let i=0;i<32;i++)a[i]=parseInt(t.slice(i*2,i*2+2),16);const s=await e.verifyWitness(a);if(s.ok)S.value="ok",R.value=t,c("ok",`witness ${t.slice(0,16)}… matches · determinism gate ✓`);else{S.value="fail";const i=Array.from(s.actual).map(r=>r.toString(16).padStart(2,"0")).join("");R.value=i,c("err",`WITNESS MISMATCH actual=${i.slice(0,16)}…`)}}catch(t){S.value="fail",c("err",`verify failed: ${t.message}`)}}}renderHeader(){return this.expanded?o`
    ...
    `:""}renderSignalTab(){const r=v=>{let L="";return v.forEach((M,A)=>{const me=A/Math.max(1,199)*320,te=65-M*22;L+=(A===0?"M":"L")+` ${me.toFixed(1)} ${te.toFixed(1)} `}),L},n=ze.value,l=[n[0]*1e9,n[1]*1e9,n[2]*1e9],d=Se.value.length>0;return o`
      ${d?"":o`
      ...
      <div class=${this.expanded?"grid-2":""}>
        <div class="card">
          ...
          <svg viewBox="0 0 ${320} ${130}" preserveAspectRatio="none">
            ...
            ${le`<path id="trace-x" d=${r(Se.value)} stroke="oklch(0.78 0.14 70)" stroke-width="1.2" fill="none"/>`}
            ${le`<path id="trace-y" d=${r(Ne.value)} stroke="oklch(0.78 0.12 195)" stroke-width="1.2" fill="none" opacity="0.8"/>`}
            ${le`<path id="trace-z" d=${r(Le.value)} stroke="oklch(0.72 0.18 330)" stroke-width="1.2" fill="none" opacity="0.7"/>`}
          </svg>
        ...
        <div class="card">
          ...
          <div class="frame-strip" id="frame-strip">
            ${_e.value.map(v=>o`<div class="bar" style=${`height:${Math.max(4,v*100)}%`}></div>`)}
          </div>
          ${this.expanded?o`
            <div style="display:flex;gap:24px;font-family:var(--mono);font-size:12px;color:var(--ink-3);margin-top:12px;">
              <span>frames in window: <span style="color:var(--ink);">${_e.value.length}</span></span>
              <span>noise floor: <span style="color:var(--ink);">${Q.value?Q.value.noiseFloorPtSqrtHz.toFixed(2)+" pT/√Hz":"—"}</span></span>
            </div>`:""}
        </div>
      </div>
    `}renderFrameTab(){const e=Q.value,t=e?.raw;let a="";return t&&(a=Array.from(t).map(i=>i.toString(16).padStart(2,"0")).slice(0,60).join(" ")),o`
      ${e?"":o`
        <div class="card" style="text-align:center; padding:18px;">
          <div style="font-size:13px; color:var(--ink-2); line-height:1.55;">
    ...
    `}renderWitnessTab(){const e=S.value,t=e==="ok"?"ok":e==="fail"?"fail":"",a=e==="pending"?"Verifying…":e==="ok"?"✓ Witness verified · determinism gate":e==="fail"?"✗ Witness mismatch · audit required":"Verify witness",s=N.value&&R.value&&N.value===R.value;return o`
      ${this.expanded?o`
      ...
      <div class="card">
        ...
        <div class="witness-box" id="expected-witness">${N.value||"(loading…)"}</div>
      </div>
      <div class="card">
        <div class="card-h">
  ...
  `;Ye([u()],ce.prototype,"tab",2);Ye([Ge({attribute:!1})],ce.prototype,"pinTab",2);Ye([Ge({type:Boolean,reflect:!0})],ce.prototype,"expanded",2);ce=Ye([w("nv-inspector")],ce);var sa=Object.defineProperty,ia=Object.getOwnPropertyDescriptor,yt=(e,t,a,s)=>{for(var i=s>1?void 0:s?ia(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&sa(t,a,i),i};let Ve=class extends x{constructor(){super(...arguments),this.hIdx=-1,this.onKey=e=>{if(e.key==="Enter")this.exec(this.inputEl.value),this.inputEl.value="";else if(e.key==="ArrowUp"){const t=X.value;t.length&&(this.hIdx=Math.max(0,this.hIdx-1),this.inputEl.value=t[this.hIdx]??"",e.preventDefault())}else if(e.key==="ArrowDown"){const t=X.value;t.length&&(this.hIdx=Math.min(t.length,this.hIdx+1),this.inputEl.value=t[this.hIdx]??"",e.preventDefault())}}}connectedCallback(){super.connectedCallback(),g(()=>{B.value,Je.value,we.value,this.requestUpdate()})}updated(){const e=this.renderRoot.querySelector(".body");e&&(e.scrollTop=e.scrollHeight)}counts(){const e={info:0,warn:0,err:0,dbg:0,ok:0};for(const t of B.value)e[t.level]=(e[t.level]??0)+1;return e.all=B.value.length,e}async exec(e){if(e=e.trim(),!e)return;c("info",`<span style="color:var(--accent);">nvsim&gt;</span> ${e}`),Nt(e),this.hIdx=X.value.length;const[t,...a]=e.split(/\s+/),s=a.join(" "),i=f();switch(t){case"help":c("info","commands: help · scene.list · sensor.config · run · pause · reset · seed · proof.verify · proof.export · clear · theme · status");break;case"scene.list":c("info","scene rebar-walkby-01:"),c("info","  rebar.steel.coil   @ [+2.7, 0.0, +0.3] m χ=5000"),c("info","  dipole.heart_proxy @ [-1.4, +0.2, +0.4] m m=1.0e-6 A·m²"),c("info","  loop.mains_60Hz    @ [-1.6, -0.4, 0.0] m I=2 A"),c("info","  eddy.door_steel    @ [+0.0, +1.8, +0.4] m σ=1e6 S/m");break;case"sensor.config":c("info","NvSensor::cots_defaults() {"),c("info","  pos=[0,0,0], V=1mm³, N=1e12, C=0.03, T2*=200ns"),c("info","  D=2.870 GHz, γe=28 GHz/T, Γ=1.0 MHz, axes=4×〈111〉"),c("info","  δB ≈ 1.18 pT/√Hz (Barry 2020 §III.A) }");break;case"run":i&&(await i.run(),m.value=!0,c("ok","pipeline RUN"));break;case"pause":i&&(await i.pause(),m.value=!1,c("warn","pipeline PAUSED"));break;case"reset":i&&(await i.reset(),c("info","pipeline reset · t=0"));break;case"seed":{if(!s){c("info",`current seed = 0x${K.value.toString(16).toUpperCase()}`);break}const r=BigInt(s.startsWith("0x")?s:"0x"+s);K.value=r,i&&await i.setSeed(r),c("ok",`seed → 0x${r.toString(16).toUpperCase()}`);break}case"proof.verify":{if(!i)break;c("dbg","computing SHA-256 over 256 frames…");try{const r=N.value,n=new Uint8Array(32);for(let d=0;d<32;d++)n[d]=parseInt(r.slice(d*2,d*2+2),16);(await i.verifyWitness(n)).ok?(S.value="ok",R.value=r,c("ok",`witness ${r.slice(0,16)}… matches · determinism gate ✓`)):(S.value="fail",c("err","WITNESS MISMATCH"))}catch(r){c("err",`verify failed: ${r.message}`)}break}case"proof.export":{if(!i)break;c("dbg","building proof bundle…");try{const r=await i.exportProofBundle(),n=URL.createObjectURL(r),l=document.createElement("a");l.href=n,l.download=`nvsim-proof-${Date.now()}.json`,l.click(),URL.revokeObjectURL(n),c("ok",`proof bundle exported · ${r.size} bytes`)}catch(r){c("err",`export failed: ${r.message}`)}break}case"clear":B.value=[];break;case"theme":{const r=(s||"").toLowerCase();r==="light"||r==="dark"?($.value=r,c("ok",`theme → ${r}`)):c("info","theme [light|dark]");break}case"status":c("info",`running=${m.value} seed=0x${K.value.toString(16).toUpperCase()} verified=${S.value}`);break;default:c("err",`unknown command: ${t} · try help`)}}render(){const e=this.counts(),t=Je.value,a=B.value.filter(s=>t==="all"||s.level===t);return o`
      <div class="tabs">
        ...
        <div class="tools">
          ...
          <button id="pause-log" title="Pause" @click=${()=>we.value=!we.value}>
            ${we.value?"▶":"❚❚"}
          </button>
        </div>
      </div>
      ...
      <div class="body">
        ...
        <div class="group">
          ...
          <div class="row">
            ...
            <span class="toggle ${fe.value?"on":""}"
              role="switch" aria-checked=${fe.value}
              @click=${()=>fe.value=!fe.value}></span>
          </div>
        </div>
        ...
        <div class="group">
          ...
          ${z.value==="ws"?o`
            <div class="row">
              ...
              <input type="text" placeholder="ws://localhost:7878" .value=${H.value}
                @input=${e=>H.value=e.target.value} />
            </div>`:""}
        </div>
